<nav id="navbar" class="bg-transparent fixed w-full z-20 top-0 start-0 px-2 md:px-12 text-white md:text-sm transition-all duration-300">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <div class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-base md:text-xl md:mb-1 lg:mb-0 font-semibold whitespace-nowrap">Lorem, ipsum.</span>
        </div>
        ...
        <div class="hidden lg:flex items-center justify-between w-full md:w-auto md:space-x-3 rtl:space-x-reverse text-sm ">
            <ul class="flex flex-col md:flex-row p-4 md:mr-8 md:p-0 mt-4 md:mt-0 font-medium border border-gray-100 rounded-lg md:space-x-4 rtl:space-x-reverse md:border-0">
                <li><a href="#home" class="block py-2 px-2 hover:text-orange-900 nav-link transition duration-300" aria-current="page">Home</a></li>
                <li><a href="#about" class="block py-2 px-2 hover:text-orange-900 nav-link transition duration-300">About</a></li>
                <li><a href="#services" class="block py-2 px-2 hover:text-orange-900 nav-link transition duration-300">Services</a></li>
                <li><a href="#price" class="block py-2 px-2 hover:text-orange-900 nav-link transition duration-300">Price</a></li>
                <li><a href="#faq" class="block py-2 px-2 hover:text-orange-900 nav-link transition duration-300">FAQ</a></li>
                <li><a href="#contact" class="block py-2 px-2 hover:text-orange-900 nav-link transition duration-300">Contact</a></li>
            </ul>

            <!-- Desktop Buttons -->
            <div class="hidden lg:flex space-x-4 rtl:space-x-reverse">
                <a href="http://my.idneobilling.com/">
                    <button type="button" class="border-2 border-white px-8 py-2 rounded-full text-white font-medium text-xs hover:bg-white hover:text-orange-900 hover:shadow-xl active:bg-slate-100 focus:outline-none focus:ring focus:ring-orange-300 transition duration-300">My Account</button>             
                </a>
                <a href="" class="flex justify-center items-center bg-white px-4 py-2 rounded-lg text-black font-medium text-xs hover:shadow-xl hover:text-orange-800">
...
<div class="items-center justify-center fixed z-10 w-full px-4 mt-16">
            ...
            <div id="dropdown-menu" class="items-center top-16 my-4 w-full text-black border-2 border-orange-300 hidden lg:hidden bg-white rounded-xl py-4">
                <ul class="flex flex-col text-base font-medium w-full space-y-2">
                    <li><a href="#home" class="block py-4 px-6 border-b border-gray-50 hover:bg-slate-100">Home</a></li>
                    <li><a href="#about" class="block py-4 px-6 border-b border-gray-50 hover:bg-slate-100">About</a></li>
                    <li><a href="#services" class="block py-4 px-6 border-b border-gray-50 hover:bg-slate-100">Services</a></li>
                    <li><a href="#price" class="block py-4 px-6 border-b border-gray-50 hover:bg-slate-100">Price</a></li>
                    <li><a href="#faq" class="block py-4 px-6 border-b border-gray-50 hover:bg-slate-100">FAQ</a></li>
                    <li><a href="#contact" class="block py-4 px-6 border-b border-gray-50 hover:bg-slate-100">Contact</a></li>
                    <hr class="w-1/2 bg-gray-600 mx-auto text-center">

                {{-- button mobile --}}
                    <div class="justify-between">
                        <div class="grid grid-cols-2 gap-2 px-4 text-sm mt-4">
                            <a href="http://my.idneobilling.com/" class="text-center text-orange-600 font-semibold border-2 border-orange-400 hover:bg-white hover:text-orange-500 py-4 rounded-full hover:shadow-lg">
                                <button class="">My Account</button>
                            </a>
                            <a href="#" class="flex justify-center items-center border border-gray-400 hover:bg-white text-orange-600 hover:text-orange-300 hover:shadow-lg py-4 rounded-lg">
                                <button class="flex items-center justify-center">
                                    <!-- WhatsApp Icon -->
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-6 h-6 text-green-500" fill="currentColor">
                                        <path d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7 .9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z"/>
                                    </svg>
                                    <!-- WhatsApp Text -->
                                    <span>Chat on WhatsApp</span>
